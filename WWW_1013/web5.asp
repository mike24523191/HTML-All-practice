...
<div class="w">
 ...
 <p>想分享的主題:
    <select name="d" required />
       ...
       <option value="特色文化" checked>特色文化</option>
       <option value="特產小吃" checked>特產小吃</option>
       <option value="旅遊趣事" checked>旅遊趣事</option>
    </select></p>
 <p>分享內容:
    <input type="text" size="30" name="e" required /></p>
 <p>是否收到臺灣快樂自由行每周旅遊資訊:<br>
    <input type="radio" value="是" name="f" checked>是，我需要
    <input type="radio" value="是" name="f" checked>不，不需要</p>
